...
+-------------+------------+------------+-------+-------+
| BLOCKS      | IMPLEMENTA-| LUT        | MUX   | TIME  |
| BLOCK_WIDTH | TION       |            |       |       |
+=============+============+============+=======+=======+
| 8|8         | V0         | 128        | 0     | /     |
+-------------+------------+------------+-------+-------+
...
| 8|8         | V4         | 96         | 0     | 0.63ns|
+-------------+------------+------------+-------+-------+
| 64|16       | V0         | 1700       | 10000 | 1.44ns|
+-------------+------------+------------+-------+-------+
| 64|16       | V1         | 4876       | 400   | 1.29ns|
+-------------+------------+------------+-------+-------+
| 64|16       | V2         | 3847       | 180   | 1.54ns|
+-------------+------------+------------+-------+-------+
| 64|16       | V3         | 4855       | 0     | 1.88ns|
+-------------+------------+------------+-------+-------+
| 64|16       | V4         | 1920       | 0     | 0.95ns|
+-------------+------------+------------+-------+-------+
| 64|10       | V0         | 23000      | 5000  | /     |
+-------------+------------+------------+-------+-------+
| 64|10       | V1         | 2088       | 0     | /     |
+-------------+------------+------------+-------+-------+
| 64|10       | V2         | 14000      | 2000  | 1.54ns|
+-------------+------------+------------+-------+-------+
| 64|10       | V3         | 4855       | 0     | 1.87ns|
+-------------+------------+------------+-------+-------+
| 64|10       | V4         | 1920       | 0     | 0.95ns|
+-------------+------------+------------+-------+-------+
| 100|10      | V0         | 26000      | 5000  | 6.94ns|
+-------------+------------+------------+-------+-------+
| 100|10      | V1         | 47000      | 12000 | 3.28ns|
+-------------+------------+------------+-------+-------+
| 100|10      | V2         | 14000      | 2000  | 1.75ns|
+-------------+------------+------------+-------+-------+
| 100|10      | V3         | 9257       | 0     | 3.51ns|
+-------------+------------+------------+-------+-------+
| 100|10      | V4         | 4053       | 0     | 0.956ns
+-------------+------------+------------+-------+-------+
| 10|16       | V0         | 2075       | 10    | 5.19ns|
+-------------+------------+------------+-------+-------+
| 10|16       | V1         | 320        | 0     | 0.71ns|
+-------------+------------+------------+-------+-------+
| 10|16       | V2         | 351        | 0     | 0.71ns|
+-------------+------------+------------+-------+-------+
| 10|16       | V3         | 320        | 0     | 0.69ns|
+-------------+------------+------------+-------+-------+
| 10|16       | V4         | 352        | 0     | 0.72ns|
+-------------+------------+------------+-------+-------+
| 100|16      | V0         | 30000      | 13000 | 5.93ns|
+-------------+------------+------------+-------+-------+
| 100|16      | V1         | 47000      | 30000 | 2.31ns|
+-------------+------------+------------+-------+-------+
| 100|16      | V2         | 12000      | 5000  | 1.27ns|
+-------------+------------+------------+-------+-------+
| 100|16      | V3         | 13000      | 32    | 1.91ns|
+-------------+------------+------------+-------+-------+
| 100|16      | V4         | 6000       | 0     | 1.25ns|
+-------------+------------+------------+-------+-------+
| 512|8       | V0         | 445000     | 25000 | 2.13ns|
+-------------+------------+------------+-------+-------+
| 512|8       | V1         | 65000      | 30000 | 1.40ns|
+-------------+------------+------------+-------+-------+
| 512|8       | V2         | 65000      | 40000 | 1.39ns|
+-------------+------------+------------+-------+-------+
| 512|8       | V3         | 37000      | 0     | 2.44ns|
+-------------+------------+------------+-------+-------+
| 512|8       | V4         | 18000      | 0     | 1.42ns|
+-------------+------------+------------+-------+-------+
| 253|32      | V0         | 84000      | 50000 | 6.65ns|
+-------------+------------+------------+-------+-------+
| 253|32      | V1         | 595000     | 30000 | 2.35ns|
+-------------+------------+------------+-------+-------+
| 253|32      | V2         | 90000      | 58    | 1.37ns|
+-------------+------------+------------+-------+-------+
| 253|32      | V3         | 81000      | 0     | 2.24ns|
+-------------+------------+------------+-------+-------+
| 253|32      | V4         | 32000      | 0     | 1.32ns|
+-------------+------------+------------+-------+-------+
