...
These designs are 100GE and 25GE, the individual profiles that can be set are listed in :ref:`Tab. 1 <f_tile_multirate_ip_variants>`.
...
If you have other problems, look into Intel's documentation: `Intel F-Tile Ethernet Multirate Intel FPGA IP User Guide <https://cdrdv2-public.intel.com/773503/ug-714307-773503.pdf>`_ and `Intel F-Tile Dynamic Reconfiguration Suite Intel FPGA IP User Guide <https://www.intel.com/programmable/technical-pdfs/711009.pdf>`_.

.. _f_tile_multirate_ip_variants:
...
- ``-e_p``  End_profile - indicates a profile to which you want to change the IP core. :ref:`Tab. 1 <f_tile_multirate_ip_variants>` lists possible variants.
