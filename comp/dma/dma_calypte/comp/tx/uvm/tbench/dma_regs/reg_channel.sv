...
class regmodel_channel #(integer POINTER_WIDTH) extends uvm_reg_block;
    `uvm_object_utils(uvm_tx_dma_calypte_regs::regmodel_channel #(POINTER_WIDTH))

    rand control_register                       control_reg;
    rand status_register                        status_reg;
    rand exper_register                         exper_reg;
    rand pointer_register #(POINTER_WIDTH)      sw_data_pointer_reg;
    rand pointer_register #(POINTER_WIDTH)      sw_hdr_pointer_reg;
    rand pointer_register #(POINTER_WIDTH)      hw_data_pointer_reg;
    rand pointer_register #(POINTER_WIDTH)      hw_hdr_pointer_reg;
    rand upd_timeout_register                   upd_timeout_reg;
    rand addr_register                          update_base_reg;
    rand pointer_mask_register #(POINTER_WIDTH) data_mask_reg;
    rand pointer_mask_register #(POINTER_WIDTH) hdr_mask_reg;
    ...
    function void set_frontdoor(uvm_reg_frontdoor frontdoor);
        ...
        $cast(c_frontdoor, frontdoor.clone());
        exper_reg            .set_frontdoor(c_frontdoor);
        $cast(c_frontdoor, frontdoor.clone());
        ...
        $cast(c_frontdoor, frontdoor.clone());
        upd_timeout_reg      .set_frontdoor(c_frontdoor);
        $cast(c_frontdoor, frontdoor.clone());
        update_base_reg      .set_frontdoor(c_frontdoor);
        $cast(c_frontdoor, frontdoor.clone());
    ...
    virtual function void build(uvm_reg_addr_t base, int unsigned bus_width);
        ...
        exper_reg             = exper_register                        ::type_id::create("exper_reg");
        sw_data_pointer_reg   = pointer_register #(POINTER_WIDTH)     ::type_id::create("sw_data_pointer_reg");
        sw_hdr_pointer_reg    = pointer_register #(POINTER_WIDTH)     ::type_id::create("sw_hdr_pointer_reg");
        hw_data_pointer_reg   = pointer_register #(POINTER_WIDTH)     ::type_id::create("hw_data_pointer_reg");
        hw_hdr_pointer_reg    = pointer_register #(POINTER_WIDTH)     ::type_id::create("hw_hdr_pointer_reg");
        upd_timeout_reg       = upd_timeout_register                  ::type_id::create("upd_timeout_reg");
        update_base_reg       = addr_register                         ::type_id::create("update_base_reg");
        data_mask_reg         = pointer_mask_register #(POINTER_WIDTH)::type_id::create("data_mask_reg");
        hdr_mask_reg          = pointer_mask_register #(POINTER_WIDTH)::type_id::create("hdr_mask_reg");
        ...
        upd_timeout_reg      .build();
        update_base_reg      .build();
        data_mask_reg        .build();
        hdr_mask_reg         .build();
        ...
        upd_timeout_reg      .configure(this);
        update_base_reg      .configure(this);
        ...
        this.default_map.add_reg(exper_reg,             'h08, "RW");
        ...
        this.default_map.add_reg(upd_timeout_reg,       'h20, "RW");
        this.default_map.add_reg(update_base_reg,       'h50, "RW");
