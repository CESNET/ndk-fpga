...
class sequencer #(
    ...
    `uvm_component_param_utils(uvm_tx_dma_calypte::sequencer #(
        USR_MFB_REGIONS, USR_MFB_REGION_SIZE, USR_MFB_BLOCK_SIZE, USR_MFB_ITEM_WIDTH, CHANNELS, HDR_META_WIDTH,
        PKT_SIZE_MAX, DATA_POINTER_WIDTH, PCIE_RQ_REGIONS, PCIE_RQ_REGION_SIZE, PCIE_RQ_BLOCK_SIZE, PCIE_RQ_ITEM_WIDTH))
    ...
    uvm_mfb::sequencer #(USR_MFB_REGIONS, USR_MFB_REGION_SIZE, USR_MFB_BLOCK_SIZE, USR_MFB_ITEM_WIDTH,
                         USER_META_WIDTH)                             m_usr_mfb_sqcr;
    uvm_mfb::sequencer #(PCIE_RQ_REGIONS, PCIE_RQ_REGION_SIZE, PCIE_RQ_BLOCK_SIZE, PCIE_RQ_ITEM_WIDTH,
                         sv_pcie_meta_pack::PCIE_RQ_META_WIDTH)       m_ptr_upd_mfb_sqcr;
