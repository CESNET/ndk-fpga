...
class env #(
    ...
    uvm_logic_vector_array_mfb::env_tx #(PCIE_RQ_REGIONS, PCIE_RQ_REGION_SIZE, PCIE_RQ_BLOCK_SIZE, PCIE_RQ_ITEM_WIDTH,
                                         PCIE_RQ_META_WIDTH)                                      m_pcie_rq_mfb_env;
    uvm_mvb::agent_rx #(1, 1)                                                                     m_pkt_disc_mvb_env;
    uvm_mi::regmodel #(regmodel #(CHANNELS), MI_WIDTH, MI_WIDTH)                                  m_regmodel;
    scoreboard #(USR_MFB_ITEM_WIDTH, CHANNELS, PKT_SIZE_MAX, PCIE_RQ_META_WIDTH, DEVICE, POINTER_WIDTH,
                 SW_ADDR_WIDTH)                                                                   m_scoreboard;

    uvm_logic_vector_mvb::env_rx #(1, PTR_UPD_REQ_MVB_ITEM_W)                                     m_ptr_upd_req_mvb_env;
    uvm_logic_vector_array_mfb::env_tx #(PCIE_RQ_REGIONS, PCIE_RQ_REGION_SIZE, PCIE_RQ_BLOCK_SIZE, PCIE_RQ_ITEM_WIDTH,
                                         PCIE_RQ_META_WIDTH)                                      m_ptr_upd_mfb_env;
    ...
    function void build_phase(uvm_phase phase);
        ...
        uvm_config_db #(uvm_logic_vector_array_mfb::config_item)::set(this, "m_pcie_rq_mfb_env", "m_config",
                                                                      pcie_rq_mfb_env_conf);
        m_pcie_rq_mfb_env    = uvm_logic_vector_array_mfb
                               ::env_tx #(PCIE_RQ_REGIONS, PCIE_RQ_REGION_SIZE, PCIE_RQ_BLOCK_SIZE, PCIE_RQ_ITEM_WIDTH,
                                         PCIE_RQ_META_WIDTH)::type_id::create("m_pcie_rq_mfb_env", this);
        ...
        m_ptr_upd_mfb_env = uvm_logic_vector_array_mfb
                            ::env_tx #(PCIE_RQ_REGIONS, PCIE_RQ_REGION_SIZE, PCIE_RQ_BLOCK_SIZE, PCIE_RQ_ITEM_WIDTH,
                                       PCIE_RQ_META_WIDTH)::type_id::create("m_ptr_upd_mfb_env", this);
