...
class test_base #(int unsigned RX_ITEMS, int unsigned TX_ITEMS, int unsigned ITEM_WIDTH) extends uvm_test;
    typedef uvm_component_registry #(test::test_base #(RX_ITEMS, TX_ITEMS, ITEM_WIDTH), "test::test_base") type_id;

    // Verification environment
    uvm_mvb_shakedown::env #(RX_ITEMS, TX_ITEMS, ITEM_WIDTH) m_env;
    ...
    function void build_phase(uvm_phase phase);
        ...
        m_env = uvm_mvb_shakedown::env #(RX_ITEMS, TX_ITEMS, ITEM_WIDTH)::type_id::create("m_env", this);
    endfunction
