...
class virt_sequencer#(REG_DEPTH, SLICE_WIDTH, SW_WIDTH) extends uvm_sequencer;
    `uvm_component_param_utils(uvm_lookup_table::virt_sequencer#(REG_DEPTH, SLICE_WIDTH, SW_WIDTH))
