...
class ex_test extends uvm_test;
    ...
    function void build_phase(uvm_phase phase);
        uvm_logic_vector_mvb::sequence_lib_rx #(MVB_ITEMS, REG_DEPTH - SLICE_WIDTH)::type_id::set_inst_override(
            mfb_rx_rand #(MVB_ITEMS, REG_DEPTH - SLICE_WIDTH)::get_type(),
        {this.get_full_name(), ".m_env.rx_env.*"});
        m_env = uvm_lookup_table::env #(MVB_ITEMS, LUT_WIDTH, REG_DEPTH, SW_WIDTH, SLICE_WIDTH, LUT_DEPTH,
                                       SPACE_SIZE_MIN, SPACE_SIZE_MAX)::type_id::create("m_env", this);
    endfunction
    ...
    task run_seq_rx(uvm_phase phase);
        ...
        m_vseq = virt_sequence #(MVB_ITEMS, LUT_WIDTH, REG_DEPTH, ADDR_WIDTH, SLICE_WIDTH, SW_WIDTH,
