...
) extends uvm_common::comparer_base_ordered#(uvm_axi::sequence_item#(ITEMS, ITEM_WIDTH, TUSER_WIDTH));
    `uvm_component_utils(uvm_asfifox::scoreboard_cmp #(ITEMS, ITEM_WIDTH, TUSER_WIDTH))
