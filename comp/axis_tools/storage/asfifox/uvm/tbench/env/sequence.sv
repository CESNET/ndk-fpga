...
class sequence_rx_base #(
    ...
    `ndk_object_param_utils(
        uvm_asfifox::sequence_rx_base #(ITEMS, ITEM_WIDTH, TUSER_WIDTH),
        $sformatf("uvm_asfifox::sequence_rx_base#(%0d,%0d,%0d)", ITEMS, ITEM_WIDTH, TUSER_WIDTH)
    )
    ...
    function new(string name = "uvm_asfifox::sequence_rx_base");
        super.new(name);
    endfunction
