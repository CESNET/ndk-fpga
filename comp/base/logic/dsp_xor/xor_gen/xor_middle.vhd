-- xor_middle.vhd:  Implemented XOR function in DSP48E2 slice.
...
--! Vitrex-7 Ultrascale+ architecture of middle DSP block for XOR function
architecture VU_DSP of XOR_MIDDLE is

begin
    --! DSP slice instantion
    dsp48e2_inst : component dsp48e2
    generic map (
    ...
    port map (
        ...
        CEP            => '0',                        -- 1-bit input: Clock enable for PREG
