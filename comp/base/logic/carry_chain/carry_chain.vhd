...
begin
    ...
    v6_v7_gen : if DEVICE = "7SERIES" or DEVICE = "VIRTEX6" or DEVICE = "ULTRASCALE" or DEVICE = "VERSAL" generate
        ...
        signal   sig_s       : std_logic_vector(CARRY_COUNT*4-1 downto 0);
        signal   sig_co      : std_logic_vector(CARRY_COUNT*4-1 downto 0);
    begin
        first_carry_i : component carry4
        port map (
