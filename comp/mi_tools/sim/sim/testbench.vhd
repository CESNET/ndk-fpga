...
begin
    ...
    begin
        ...
        be   := "1111";
        ReadData(addr, data, be, status(0), 0);
        assert (data = X"00000004")
            report "Wrong data on address 0x0"
            severity note;
        ...
        be         := "1111";
        ReadData(addr, data, be, status(0), 0);
        assert (data = X"00000008")
            report "Wrong data on address 0x4"
            severity note;

        addr := X"00000008";
        be   := "1111";
        ReadData(addr, data, be, status(0), 0);
        assert (data = X"0000000C")
            report "Wrong data on address 0x8"
            severity note;
