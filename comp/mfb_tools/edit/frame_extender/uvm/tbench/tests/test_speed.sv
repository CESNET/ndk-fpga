...
class test_speed #(
    ...
    typedef uvm_component_registry #(test::test_speed #(MFB_REGIONS, MFB_REGION_SIZE, MFB_BLOCK_SIZE, MFB_ITEM_WIDTH,
                                                      PKT_MTU, USERMETA_WIDTH, RX_MVB_ITEM_WIDTH), "test::test_speed")
        type_id;
    ...
    function void build_phase(uvm_phase phase);
        ...
        uvm_mfb::sequence_lib_tx
            #(MFB_REGIONS, MFB_REGION_SIZE, MFB_BLOCK_SIZE, MFB_ITEM_WIDTH, USERMETA_WIDTH)::type_id::set_inst_override(
            uvm_mfb::sequence_lib_tx_speed
                #(MFB_REGIONS, MFB_REGION_SIZE, MFB_BLOCK_SIZE, MFB_ITEM_WIDTH, USERMETA_WIDTH)::get_type(),
