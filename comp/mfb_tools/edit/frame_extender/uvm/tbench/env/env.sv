...
class env #(
    ...
    `uvm_component_param_utils(uvm_mfb_frame_extender::env #(MFB_REGIONS, MFB_REGION_SIZE, MFB_BLOCK_SIZE,
                                   MFB_ITEM_WIDTH, PKT_MTU, USERMETA_WIDTH, RX_MVB_ITEM_WIDTH))
