...
class test_speed #(
    ...
    META_WIDTH,
    PKT_MTU
) extends test_base #(REGIONS, REGION_SIZE, BLOCK_SIZE, ITEM_WIDTH, META_WIDTH, PKT_MTU);
    typedef uvm_component_registry
        #(test::test_speed #(REGIONS, REGION_SIZE, BLOCK_SIZE, ITEM_WIDTH, META_WIDTH, PKT_MTU), "test::test_speed")
        type_id;
    ...
    function void build_phase(uvm_phase phase);
        ...
        uvm_logic_vector_array_mfb::sequence_lib_rx
            #(REGIONS, REGION_SIZE, BLOCK_SIZE, ITEM_WIDTH, META_WIDTH + 1 + $clog2(
            PKT_MTU + 1
