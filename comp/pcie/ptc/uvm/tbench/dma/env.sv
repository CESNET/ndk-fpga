...
class env#(
    ...
    int unsigned RQ_MFB_ITEM_WIDTH,
    ...
    logic PTC_DISABLED //-- NOT IMPLEMENTED
)  extends uvm_env;
    `uvm_component_param_utils(uvm_dma::env#(RQ_MVB_ITEMS, RQ_MFB_REGIONS, RQ_MFB_REGION_SIZE, RQ_MFB_BLOCK_SIZE, RQ_MFB_ITEM_WIDTH,
                                             RC_MVB_ITEMS, RC_MFB_REGIONS, RC_MFB_REGION_SIZE, RC_MFB_BLOCK_SIZE, RC_MFB_ITEM_WIDTH,
                                             PTC_DISABLED
                                         )
                              );

    localparam RQ_MFB_META_WIDTH = (PTC_DISABLED == 0) ? 0 : sv_pcie_meta_pack::PCIE_RQ_META_WIDTH;
    localparam RC_MFB_META_WIDTH = (PTC_DISABLED == 0) ? 0 : sv_pcie_meta_pack::PCIE_RC_META_WIDTH;
    ...
    protected uvm_logic_vector_array_mfb::env_rx #(RQ_MFB_REGIONS, RQ_MFB_REGION_SIZE, RQ_MFB_BLOCK_SIZE, RQ_MFB_ITEM_WIDTH, RQ_MFB_META_WIDTH) m_rq_mfb_env;
    protected uvm_logic_vector_mvb::env_rx #(RQ_MVB_ITEMS, DMA_UPHDR_WIDTH)                                                   m_rq_mvb_env;
    protected uvm_logic_vector_array_mfb::env_tx #(RC_MFB_REGIONS, RC_MFB_REGION_SIZE, RC_MFB_BLOCK_SIZE, RC_MFB_ITEM_WIDTH, RC_MFB_META_WIDTH) m_rc_mfb_env;
    protected uvm_logic_vector_mvb::env_tx #(RC_MVB_ITEMS, DMA_DOWNHDR_WIDTH)                                                 m_rc_mvb_env;

    protected uvm_common::fifo#(uvm_logic_vector_array::sequence_item#(32))  fifo_rq_mfb_data;
    protected uvm_common::fifo#(uvm_logic_vector::sequence_item#(DMA_UPHDR_WIDTH)) fifo_rq_mvb;
    ...
    function void build_phase(uvm_phase phase);
        ...
        assert(PTC_DISABLED == 0) else begin `uvm_fatal(this.get_full_name(), "\n\tPTC DISABLED IS NOT IMLEMENTED"); end
        ...
        m_rq_mvb_cfg.interface_name    = {m_config.interface_name, "_rq_mvb"};
        uvm_config_db #(uvm_logic_vector_mvb::config_item)::set(this, "m_rq_mvb_env", "m_config", m_rq_mvb_cfg);
        m_rq_mvb_env = uvm_logic_vector_mvb::env_rx #(RQ_MVB_ITEMS, DMA_UPHDR_WIDTH)::type_id::create("m_rq_mvb_env", this);
        ...
        m_rc_mvb_cfg.interface_name    = {m_config.interface_name, "_rc_mvb"};
        uvm_config_db #(uvm_logic_vector_mvb::config_item)::set(this, "m_rc_mvb_env", "m_config", m_rc_mvb_cfg);
        m_rc_mvb_env = uvm_logic_vector_mvb::env_tx #(RC_MVB_ITEMS, DMA_DOWNHDR_WIDTH)::type_id::create("m_rc_mvb_env", this);
        ...
        fifo_rq_mvb      = uvm_common::fifo#(uvm_logic_vector::sequence_item#(DMA_UPHDR_WIDTH))::type_id::create("fifo_rq_mvb", this);
    endfunction
    ...
    function void connect_phase(uvm_phase phase);
        ...
        uvm_config_db #(uvm_common::fifo#(uvm_logic_vector_array::sequence_item#(32)) )::set(m_rq_mfb_env.m_sequencer.m_data, "", "fifo", fifo_rq_mfb_data);
        uvm_config_db #(uvm_common::fifo#(uvm_logic_vector::sequence_item#(DMA_UPHDR_WIDTH)))::set(m_rq_mvb_env.m_sequencer       , "", "fifo"     , fifo_rq_mvb);
        uvm_config_db #(uvm_common::fifo#(uvm_logic_vector_array::sequence_item#(32)) )::set(this, "m_driver", "fifo_rq_mfb_data", fifo_rq_mfb_data);
        uvm_config_db #(uvm_common::fifo#(uvm_logic_vector::sequence_item#(DMA_UPHDR_WIDTH)))::set(this, "m_driver", "fifo_rq_mvb"     , fifo_rq_mvb);
