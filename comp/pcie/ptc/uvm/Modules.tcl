...
lappend PACKAGES "$OFM_PATH/comp/base/pkg/dma_bus_pack.sv"
...
lappend COMPONENTS [ list "RESET"  "$SV_UVM_BASE/reset"    "FULL"]
lappend COMPONENTS [ list "PCIE"  "$SV_UVM_BASE/pcie"      "FULL"]
lappend COMPONENTS [ list "PCIE"  "$SV_UVM_BASE/pcie_axi"  "FULL"]
lappend COMPONENTS [ list "PCIE"  "$SV_UVM_BASE/pcie_mfb"  "FULL"]
lappend COMPONENTS [ list "PROBE" "$SV_UVM_BASE/probe"     "FULL"]
...
set MOD "$MOD $ENTITY_BASE/tbench/dma/pkg.sv"
