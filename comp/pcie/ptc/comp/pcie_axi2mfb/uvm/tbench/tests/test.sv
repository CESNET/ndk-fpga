...
class ex_test extends uvm_test;
    ...
    function void build_phase(uvm_phase phase);
        ...
        m_env = uvm_ptc_pcie_axi2mfb::env #(REGIONS, REGION_SIZE, BLOCK_SIZE, ITEM_WIDTH, DATA_WIDTH, TUSER_WIDTH,
                                           STRADDLING)::type_id::create("m_env", this);
    endfunction
    ...
    virtual task tx_seq(uvm_phase phase);
        ...
        mfb_seq = uvm_mfb::sequence_lib_tx #(REGIONS, REGION_SIZE, BLOCK_SIZE, ITEM_WIDTH, 0)::type_id::create(
            "mfb_seq",
                                                                                                              this);

        mfb_seq.add_sequence(
            uvm_mfb::sequence_full_speed_tx #(REGIONS, REGION_SIZE, BLOCK_SIZE, ITEM_WIDTH, 0)::get_type());
