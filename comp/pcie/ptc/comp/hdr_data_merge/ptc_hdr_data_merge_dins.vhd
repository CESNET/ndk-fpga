...
begin
    ...
    assert (DEVICE = "STRATIX10" or DEVICE = "AGILEX" or DEVICE = "ULTRASCALE" or DEVICE = "7SERIES" or DEVICE = "VERSAL")
        report "PTC_HDR_DATA_MERGE_DINS: unsupported device!"
        severity failure;
    ...
    data_shift_g : for r in 0 to MFB_REGIONS-1 generate
        ...
        intel_data_shift_g : if (PTILE_RTILE_DEVICE) generate
            ...
            s_data_shifted_arr(r)(HDR_WIDTH-1 downto 0) <= s_data_shifted_over_arr(r)
            when (s_shift_4_dwords(r) = '1') else
 s_r1_mfb_data(r)(32-1 downto 0) & s_data_shifted_over_arr(r)(3*32-1 downto 0);

            s_data_shifted_arr(r)(MFB_REGION_WIDTH-1 downto HDR_WIDTH) <= s_r1_mfb_data(r)(MFB_REGION_WIDTH-HDR_WIDTH-1 downto 0)
            when (s_shift_4_dwords(r) = '1') else
 s_r1_mfb_data(r)(MFB_REGION_WIDTH-3*32-1 downto 32);

            s_data_shifted_over_arr(r+1) <= s_r1_mfb_data(r)(MFB_REGION_WIDTH-1 downto MFB_REGION_WIDTH-HDR_WIDTH)
            when (s_shift_4_dwords(r) = '1') else
 (32-1 downto 0 => '0') & s_r1_mfb_data(r)(MFB_REGION_WIDTH-1 downto MFB_REGION_WIDTH-3*32);
