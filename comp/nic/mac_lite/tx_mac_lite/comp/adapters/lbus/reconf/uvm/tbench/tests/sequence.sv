...
class virt_sequence extends uvm_sequence;
    ...
    uvm_logic_vector_array::sequence_lib #(8) m_logic_vector_array_sq_lib;

    virtual function void init();

        m_reset      = uvm_reset::sequence_start::type_id::create("m_reset");

        m_logic_vector_array_sq_lib = uvm_logic_vector_array::sequence_lib #(8)::type_id::create("m_logic_vector_array_sq_lib");

        m_logic_vector_array_sq_lib.init_sequence();
        m_logic_vector_array_sq_lib.min_random_count = 200;
        m_logic_vector_array_sq_lib.max_random_count = 300;
