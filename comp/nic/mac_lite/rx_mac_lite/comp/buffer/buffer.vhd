...
entity RX_MAC_LITE_BUFFER is
   ...
   port(
        ...
        RX_METACTRL     : in  std_logic_vector(METACTRL_WIDTH-1 downto 0) := (others => '0');
        ...
        STAT_METACTRL   : out std_logic_vector(METACTRL_WIDTH-1 downto 0);
...
architecture FULL of RX_MAC_LITE_BUFFER is
    ...
    signal s_rx_metactrl_reg    : std_logic_vector(METACTRL_WIDTH-1 downto 0);
...
begin
    ...
    begin
        if (rising_edge(RX_CLK)) then
            ...
            STAT_METACTRL   <= s_rx_metactrl_reg;
