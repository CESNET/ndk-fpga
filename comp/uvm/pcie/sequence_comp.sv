...
class sequence_comp extends uvm_common::sequence_base #(config_sequence, uvm_pcie::header);
    `uvm_object_utils(uvm_pcie::sequence_comp)
    ...
    function new(string name = "sequence_comp");
        super.new(name);
    endfunction
...
class sequence_comp_lib extends uvm_common::sequence_library#(config_sequence, uvm_pcie::header);
  ...
  function new(string name = "sequence_lib_tx");
    ...
    virtual function void init_sequence(config_sequence param_cfg = null);
        ...
        this.add_sequence(uvm_pcie::sequence_comp::get_type());
    endfunction
endclass
