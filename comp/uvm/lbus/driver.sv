    ...
    task run_phase(uvm_phase phase);
        forever begin
            ...
            if (req != null) begin
                ...
                vif.driver_rx_cb.ENA  <= req.ena;
                vif.driver_rx_cb.SOP  <= req.sop;
                vif.driver_rx_cb.EOP  <= req.eop;
                vif.driver_rx_cb.ERR  <= req.err;
                vif.driver_rx_cb.MTY  <= req.mty;
                // Start a request
                ...
                vif.driver_rx_cb.ENA  <= '0;
                vif.driver_rx_cb.SOP  <= 'X;
                vif.driver_rx_cb.EOP  <= 'X;
                vif.driver_rx_cb.ERR  <= 'X;
                vif.driver_rx_cb.MTY  <= 'X;
            end
