...
# 400G3 design
# ============
set FHIP_400G3_P0_CLK_CH23 [get_clocks cm_i|network_mod_i|eth_core_g[0].network_mod_core_i|ftile_1x400g8_g.eth_ip_g[0].ftile_1x400g8_i|ftile_eth_ip_i|eth_f_0|tx_clkout|ch23]
set FHIP_400G3_P1_CLK_CH23 [get_clocks cm_i|network_mod_i|eth_core_g[1].network_mod_core_i|ftile_1x400g8_g.eth_ip_g[0].ftile_1x400g8_i|ftile_eth_ip_i|eth_f_0|tx_clkout|ch23]
set FHIP_400G3_P2_CLK_CH23 [get_clocks cm_i|network_mod_i|eth_core_g[2].network_mod_core_i|ftile_1x400g8_g.eth_ip_g[0].ftile_1x400g8_i|ftile_eth_ip_i|eth_f_0|tx_clkout|ch23]

# Fix hold timing issues for 400G3 design
set_clock_groups -asynchronous -group $MI_CLK_CH3          -group $FHIP_400G3_P0_CLK_CH23
set_clock_groups -asynchronous -group $MI_CLK_CH3          -group $FHIP_400G3_P1_CLK_CH23
set_clock_groups -asynchronous -group $MI_CLK_CH3          -group $FHIP_400G3_P2_CLK_CH23
