...
entity BMC_WRAP is
    ...
    port(
        ...
        QSFPDD1_RST_N      : in    std_logic;
        QSFPDD1_LPMODE     : in    std_logic;
        QSFPDD1_INT_N      : out   std_logic;
        QSFPDD1_PRESENT_N  : out   std_logic;

        QSFPDD2_RST_N      : in    std_logic;
        QSFPDD2_LPMODE     : in    std_logic;
        QSFPDD2_INT_N      : out   std_logic;
        QSFPDD2_PRESENT_N  : out   std_logic;
