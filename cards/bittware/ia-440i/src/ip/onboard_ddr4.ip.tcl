...
proc do_adjust_onboard_ddr4_ip {device family ipname filename adjust_proc} {
    ...
    set_instance_parameter_value emif_fm_0 {MEM_DDR4_ALERT_N_PLACEMENT_ENUM} {DDR4_ALERT_N_PLACEMENT_AUTO}
    ...
    set_instance_parameter_value emif_fm_0 {MEM_DDR4_TRRD_L_CYC} {11}
    set_instance_parameter_value emif_fm_0 {MEM_DDR4_TRRD_S_CYC} {9}
    ...
    set_instance_parameter_value emif_fm_0 {PHY_DDR4_USER_DATA_OUT_MODE_ENUM} {OUT_OCT_34_CAL}
    ...
    set_instance_parameter_value emif_fm_0 {PHY_DDR4_MEM_CLK_FREQ_MHZ} {1600.0}
