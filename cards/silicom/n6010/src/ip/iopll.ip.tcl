...
proc do_adjust_iopll_ip {device family ipname filename} {
	...
	set_instance_parameter_value iopll_0 {gui_divide_factor_c0} {3}
	set_instance_parameter_value iopll_0 {gui_divide_factor_c1} {4}
	set_instance_parameter_value iopll_0 {gui_divide_factor_c2} {4}
	set_instance_parameter_value iopll_0 {gui_divide_factor_c3} {5}
	set_instance_parameter_value iopll_0 {gui_divide_factor_n} {2}
