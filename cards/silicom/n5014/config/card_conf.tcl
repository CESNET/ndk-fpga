...
# Number of Ethernet ports, must match number of items in list ETH_PORTS_SPEED!
set CLV_PORTS         2
# Speed for each one of the CLV_PORTS (allowed values: 100)
set CLV_PORT_SPEED(0) 100
set CLV_PORT_SPEED(1) 100
# Number of channels for each one of the CLV_PORTS (allowed values: 1 for ETH_PORT_SPEED=100)
set CLV_PORT_CHAN(0) 1
set CLV_PORT_CHAN(1) 1
# Number of lanes for each one of the ETH_PORTS
# Typical values: 4 (QSFP), 8 (QSFP-DD)
set CLV_PORT_LANES(0) 4
set CLV_PORT_LANES(1) 4
...
# DDR4 parameters:
# ------------------------------------------------------------------------------
# External DDR4 memory settings (allowed values 0).
set MEM_PORTS 0

# ------------------------------------------------------------------------------
# HBM parameters: (allowed values: 0, 16, 32)
# ------------------------------------------------------------------------------
set HBM_PORTS 0
