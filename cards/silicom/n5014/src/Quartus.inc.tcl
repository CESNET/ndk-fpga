...
set CARD_ARCHGRP(FPGA)               "1SD21BPT2F53E2VG"
...
set SYNTH_FLAGS(FPGA)                "1SD21BPT2F53E2VG"
set SYNTH_FLAGS(BITSTREAM)           "OFS_PMCI"
set SYNTH_FLAGS(OFS_PMCI_SCRIPT_DIR) "$OFM_PATH/extra/ip-3rdparty/silicom/n5014/scripts/"
