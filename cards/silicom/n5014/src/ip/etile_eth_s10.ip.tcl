...
proc do_adjust_etile_eth_ip_1x100g {} {
	...
	set_instance_parameter_value alt_ehipc3_0 {core_variant} {2}
	set_instance_parameter_value alt_ehipc3_0 {ehip_mode_gui} {MAC+PCS+(528,514)RSFEC}
	set_instance_parameter_value alt_ehipc3_0 {ehip_mode_gui_sl_0} {MAC+PCS+RSFEC}
	...
	set_instance_parameter_value alt_ehipc3_0 {rx_max_frame_size_gui} {16383}
	set_instance_parameter_value alt_ehipc3_0 {rx_vlan_detection_gui} {0}
	set_instance_parameter_value alt_ehipc3_0 {tx_max_frame_size_gui} {16383}
	set_instance_parameter_value alt_ehipc3_0 {tx_vlan_detection_gui} {0}
