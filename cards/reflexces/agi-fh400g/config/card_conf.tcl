...
# 2x PCIe Gen5 x16  -- PCIE_GEN=5, PCIE_ENDPOINTS=2, PCIE_ENDPOINT_MODE=0 (Note: for DMA Medusa only)
...
# 2x PCIe Gen5 x8x8 -- PCIE_GEN=5, PCIE_ENDPOINTS=4, PCIE_ENDPOINT_MODE=1 (Note: for DMA Medusa only, requires PCIe bifurcation enabled in BIOS)
