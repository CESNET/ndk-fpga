...
if {$BOARD_REV == 0} {
    ...
    set SYNTH_FLAGS(CONSTR) "$SYNTH_FLAGS(CONSTR) $CARD_BASE/constr/general-rev0-1.qsf"
}
if {$BOARD_REV == 1} {
...
if {$BOARD_REV == 2} {
    ...
    set SYNTH_FLAGS(CONSTR) "$SYNTH_FLAGS(CONSTR) $CARD_BASE/constr/general-rev2.qsf"
}
