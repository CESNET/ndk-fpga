...
# create the system "iopll_ip"
proc do_create_iopll_ip {device family ipname filename} {
	# create the system
	...
	set_instance_parameter_value iopll_0 {hp_qsys_scripting_mode} {1}
...
do_create_iopll_ip $PARAMS(IP_DEVICE) $PARAMS(IP_DEVICE_FAMILY) $PARAMS(IP_COMP_NAME) [get_ip_filename $PARAMS(IP_COMP_NAME)]
