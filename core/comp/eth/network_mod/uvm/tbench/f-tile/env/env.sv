...
class env #(
    ...
    `uvm_component_param_utils(
        uvm_network_mod_f_tile_env::env #(
            ETH_CORE_ARCH,
            ETH_PORTS,
            ETH_PORT_SPEED,
            ETH_PORT_CHAN,
    ...
    function void build_phase(uvm_phase phase);
        ...
        uvm_network_mod_env::sequencer_port
            ...
            uvm_network_mod_f_tile_env::sequencer_port
                #(ETH_TX_HDR_WIDTH, ETH_RX_HDR_WIDTH, ITEM_WIDTH, REGIONS, REGION_SIZE, BLOCK_SIZE, ETH_PORT_CHAN[0],
        ...
        uvm_network_mod_env::model #(ETH_CORE_ARCH, ETH_PORTS, ETH_PORT_SPEED, ETH_PORT_CHAN, REGIONS, ITEM_WIDTH,
                                    ETH_TX_HDR_WIDTH, ETH_RX_HDR_WIDTH)::type_id::set_inst_override(
            uvm_network_mod_f_tile_env::model #(ETH_CORE_ARCH, ETH_PORTS, ETH_PORT_SPEED, ETH_PORT_CHAN, REGIONS,
                                               ITEM_WIDTH, ETH_TX_HDR_WIDTH, ETH_RX_HDR_WIDTH)::get_type(),
        ...
        uvm_network_mod_env::virt_sequence_port
            ...
            uvm_network_mod_f_tile_env::virt_sequence_port
                #(ETH_TX_HDR_WIDTH, ETH_RX_HDR_WIDTH, ITEM_WIDTH, REGIONS, REGION_SIZE, BLOCK_SIZE, ETH_PORT_CHAN[0],
                  MI_DATA_WIDTH, MI_ADDR_WIDTH)::get_type()
        );
        uvm_network_mod_env::virt_sequence_simple
            ...
            uvm_network_mod_f_tile_env::virt_sequence_simple
                #(ETH_PORTS, ETH_TX_HDR_WIDTH, ETH_RX_HDR_WIDTH, ITEM_WIDTH, REGIONS, REGION_SIZE, BLOCK_SIZE,
        ...
        for (int unsigned it = 0; it < ETH_PORTS; it++) begin
            ...
            uvm_config_db #(uvm_logic_vector_array_intel_mac_seg::config_item)::set(this, $sformatf("m_eth_rx_%0d", it),
                                                                                   "m_config", cfg_eth_rx);
            ...
            uvm_config_db #(uvm_logic_vector_array_intel_mac_seg::config_item)::set(this, $sformatf("m_eth_tx_%0d", it),
                                                                                   "m_config", cfg_eth_tx);
            // verilog_lint: waive line-length
