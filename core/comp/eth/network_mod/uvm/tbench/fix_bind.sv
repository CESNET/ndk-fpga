...
module fix_bind #(int unsigned PORTS, int unsigned CHANNELS);
    ...
    if (PORTS == 1) begin : gen_PORTS_1
        bind RX_MAC_LITE_BUFFER : $root.testbench.DUT_U.DUT_BASE_U.VHDL_DUT_U.eth_core_g[0].network_mod_logic_i.rx_g[
            0].rx_mac_g.rx_mac_i.buffer_i
        ...
        bind RX_MAC_LITE_BUFFER : $root.testbench.DUT_U.DUT_BASE_U.VHDL_DUT_U.eth_core_g[1].network_mod_logic_i.rx_g[
            0].rx_mac_g.rx_mac_i.buffer_i
                probe_inf #(2*REGIONS) probe_drop(
                .event_signal(s_rx_src_rdy_orig_reg              ),
                .event_data  ({s_rx_eof_orig_reg, s_rx_force_drop_reg}),
        ...
        bind RX_MAC_LITE_BUFFER : $root.testbench.DUT_U.DUT_BASE_U.VHDL_DUT_U.eth_core_g[2].network_mod_logic_i.rx_g[
            0].rx_mac_g.rx_mac_i.buffer_i
                probe_inf #(2*REGIONS) probe_drop(
                .event_signal(s_rx_src_rdy_orig_reg              ),
                .event_data  ({s_rx_eof_orig_reg, s_rx_force_drop_reg}),
        ...
        bind RX_MAC_LITE_BUFFER : $root.testbench.DUT_U.DUT_BASE_U.VHDL_DUT_U.eth_core_g[3].network_mod_logic_i.rx_g[
            0].rx_mac_g.rx_mac_i.buffer_i
                probe_inf #(2*REGIONS) probe_drop(
                .event_signal(s_rx_src_rdy_orig_reg              ),
                .event_data  ({s_rx_eof_orig_reg, s_rx_force_drop_reg}),
