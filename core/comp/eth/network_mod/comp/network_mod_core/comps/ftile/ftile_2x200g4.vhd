...
architecture FULL of FTILE_2X200G4 is
    ...
    component ftile_eth_2x200g is
        port (
            ...
            I_TX_MAC_DATA                   : in  std_logic_vector(511 downto 0) := (others => 'X');
            I_TX_MAC_VALID                  : in  std_logic                      := 'X';
            I_TX_MAC_INFRAME                : in  std_logic_vector(7 downto 0)   := (others => 'X');
            I_TX_MAC_EOP_EMPTY              : in  std_logic_vector(23 downto 0)  := (others => 'X');
            O_TX_MAC_READY                  : out std_logic;
            I_TX_MAC_ERROR                  : in  std_logic_vector(7 downto 0)   := (others => 'X');
            I_TX_MAC_SKIP_CRC               : in  std_logic_vector(7 downto 0)   := (others => 'X');
            O_RX_MAC_DATA                   : out std_logic_vector(511 downto 0);
            O_RX_MAC_VALID                  : out std_logic;
            O_RX_MAC_INFRAME                : out std_logic_vector(7 downto 0);
            O_RX_MAC_EOP_EMPTY              : out std_logic_vector(23 downto 0);
            O_RX_MAC_FCS_ERROR              : out std_logic_vector(7 downto 0);
            O_RX_MAC_ERROR                  : out std_logic_vector(15 downto 0);
            O_RX_MAC_STATUS                 : out std_logic_vector(23 downto 0);
