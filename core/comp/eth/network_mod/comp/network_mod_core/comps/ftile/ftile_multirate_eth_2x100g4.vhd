...
architecture FULL of FTILE_MULTIRATE_ETH_2X100G4 is
    ...
    component ftile_multirate_eth_1x100g is
        port (
            ...
            O_P1_CLK_TX_DIV                  : out std_logic;
            O_P1_CLK_REC_DIV64               : out std_logic;
            O_P1_CLK_REC_DIV                 : out std_logic;
            I_P1_RST_N                       : in  std_logic                      := 'X';
            I_P1_TX_RST_N                    : in  std_logic                      := 'X';
            I_P1_RX_RST_N                    : in  std_logic                      := 'X';
            O_P1_RST_ACK_N                   : out std_logic;
            O_P1_RX_RST_ACK_N                : out std_logic;
            O_P1_TX_RST_ACK_N                : out std_logic;
            O_P1_TX_PLL_LOCKED               : out std_logic;
            ...
            O_P1_RX_AM_LOCK                  : out std_logic;
            O_P1_LOCAL_FAULT_STATUS          : out std_logic;
            O_P1_REMOTE_FAULT_STATUS         : out std_logic;
            I_P1_STATS_SNAPSHOT              : in  std_logic                      := 'X';
            O_P1_RX_HI_BER                   : out std_logic;
            O_P1_RX_PCS_FULLY_ALIGNED        : out std_logic;
            I_P1_RECONFIG_ETH_ADDR           : in  std_logic_vector(13 downto 0)  := (others => 'X');
            I_P1_RECONFIG_ETH_BYTEENABLE     : in  std_logic_vector(3 downto 0)   := (others => 'X');
            O_P1_RECONFIG_ETH_READDATA_VALID : out std_logic;
            I_P1_RECONFIG_ETH_READ           : in  std_logic                      := 'X';
            I_P1_RECONFIG_ETH_WRITE          : in  std_logic                      := 'X';
            O_P1_RECONFIG_ETH_READDATA       : out std_logic_vector(31 downto 0);
            I_P1_RECONFIG_ETH_WRITEDATA      : in  std_logic_vector(31 downto 0)  := (others => 'X');
            O_P1_RECONFIG_ETH_WAITREQUEST    : out std_logic;
            O_P2_CLK_TX_DIV                  : out std_logic;
            O_P2_CLK_REC_DIV64               : out std_logic;
            O_P2_CLK_REC_DIV                 : out std_logic;
            I_P2_RST_N                       : in  std_logic                      := 'X';
            I_P2_TX_RST_N                    : in  std_logic                      := 'X';
            I_P2_RX_RST_N                    : in  std_logic                      := 'X';
            O_P2_RST_ACK_N                   : out std_logic;
            O_P2_RX_RST_ACK_N                : out std_logic;
            O_P2_TX_RST_ACK_N                : out std_logic;
            O_P2_TX_PLL_LOCKED               : out std_logic;
            ...
            O_P2_RX_AM_LOCK                  : out std_logic;
            O_P2_LOCAL_FAULT_STATUS          : out std_logic;
            O_P2_REMOTE_FAULT_STATUS         : out std_logic;
            I_P2_STATS_SNAPSHOT              : in  std_logic                      := 'X';
            O_P2_RX_HI_BER                   : out std_logic;
            O_P2_RX_PCS_FULLY_ALIGNED        : out std_logic;
            I_P2_RECONFIG_ETH_ADDR           : in  std_logic_vector(13 downto 0)  := (others => 'X');
            I_P2_RECONFIG_ETH_BYTEENABLE     : in  std_logic_vector(3 downto 0)   := (others => 'X');
            O_P2_RECONFIG_ETH_READDATA_VALID : out std_logic;
            I_P2_RECONFIG_ETH_READ           : in  std_logic                      := 'X';
            I_P2_RECONFIG_ETH_WRITE          : in  std_logic                      := 'X';
            O_P2_RECONFIG_ETH_READDATA       : out std_logic_vector(31 downto 0);
            I_P2_RECONFIG_ETH_WRITEDATA      : in  std_logic_vector(31 downto 0)  := (others => 'X');
            O_P2_RECONFIG_ETH_WAITREQUEST    : out std_logic;
            O_P3_CLK_TX_DIV                  : out std_logic;
            O_P3_CLK_REC_DIV64               : out std_logic;
            O_P3_CLK_REC_DIV                 : out std_logic;
            I_P3_RST_N                       : in  std_logic                      := 'X';
            I_P3_TX_RST_N                    : in  std_logic                      := 'X';
            I_P3_RX_RST_N                    : in  std_logic                      := 'X';
            O_P3_RST_ACK_N                   : out std_logic;
            O_P3_RX_RST_ACK_N                : out std_logic;
            O_P3_TX_RST_ACK_N                : out std_logic;
            O_P3_TX_PLL_LOCKED               : out std_logic;
            ...
            O_P3_RX_AM_LOCK                  : out std_logic;
            O_P3_LOCAL_FAULT_STATUS          : out std_logic;
            O_P3_REMOTE_FAULT_STATUS         : out std_logic;
            I_P3_STATS_SNAPSHOT              : in  std_logic                      := 'X';
            O_P3_RX_HI_BER                   : out std_logic;
            O_P3_RX_PCS_FULLY_ALIGNED        : out std_logic;
            I_P3_RECONFIG_ETH_ADDR           : in  std_logic_vector(13 downto 0)  := (others => 'X');
            I_P3_RECONFIG_ETH_BYTEENABLE     : in  std_logic_vector(3 downto 0)   := (others => 'X');
            O_P3_RECONFIG_ETH_READDATA_VALID : out std_logic;
            I_P3_RECONFIG_ETH_READ           : in  std_logic                      := 'X';
            I_P3_RECONFIG_ETH_WRITE          : in  std_logic                      := 'X';
            O_P3_RECONFIG_ETH_READDATA       : out std_logic_vector(31 downto 0);
            I_P3_RECONFIG_ETH_WRITEDATA      : in  std_logic_vector(31 downto 0)  := (others => 'X');
            O_P3_RECONFIG_ETH_WAITREQUEST    : out std_logic;
            I_CLK_PLL                        : in  std_logic                      := 'X';
            I_P0_CLK_TX_TOD                  : in  std_logic                      := 'X';
            I_P0_CLK_RX_TOD                  : in  std_logic                      := 'X';
            I_P1_CLK_TX_TOD                  : in  std_logic                      := 'X';
            I_P1_CLK_RX_TOD                  : in  std_logic                      := 'X';
            I_P2_CLK_TX_TOD                  : in  std_logic                      := 'X';
            I_P2_CLK_RX_TOD                  : in  std_logic                      := 'X';
            I_P3_CLK_TX_TOD                  : in  std_logic                      := 'X';
            I_P3_CLK_RX_TOD                  : in  std_logic                      := 'X';
            ...
            I_RECONFIG_XCVR2_ADDR            : in  std_logic_vector(17 downto 0)  := (others => 'X');
            I_RECONFIG_XCVR2_BYTEENABLE      : in  std_logic_vector(3 downto 0)   := (others => 'X');
            O_RECONFIG_XCVR2_READDATA_VALID  : out std_logic;
            I_RECONFIG_XCVR2_READ            : in  std_logic                      := 'X';
            I_RECONFIG_XCVR2_WRITE           : in  std_logic                      := 'X';
            O_RECONFIG_XCVR2_READDATA        : out std_logic_vector(31 downto 0);
            I_RECONFIG_XCVR2_WRITEDATA       : in  std_logic_vector(31 downto 0)  := (others => 'X');
            O_RECONFIG_XCVR2_WAITREQUEST     : out std_logic;
            I_RECONFIG_XCVR3_ADDR            : in  std_logic_vector(17 downto 0)  := (others => 'X');
            I_RECONFIG_XCVR3_BYTEENABLE      : in  std_logic_vector(3 downto 0)   := (others => 'X');
            O_RECONFIG_XCVR3_READDATA_VALID  : out std_logic;
            I_RECONFIG_XCVR3_READ            : in  std_logic                      := 'X';
            I_RECONFIG_XCVR3_WRITE           : in  std_logic                      := 'X';
            O_RECONFIG_XCVR3_READDATA        : out std_logic_vector(31 downto 0);
            I_RECONFIG_XCVR3_WRITEDATA       : in  std_logic_vector(31 downto 0)  := (others => 'X');
            O_RECONFIG_XCVR3_WAITREQUEST     : out std_logic;
            I_TX_MAC_DATA                    : in  std_logic_vector(255 downto 0) := (others => 'X');
            I_TX_MAC_VALID                   : in  std_logic_vector(3 downto 0)   := (others => 'X');
            I_TX_MAC_INFRAME                 : in  std_logic_vector(3 downto 0)   := (others => 'X');
            I_TX_MAC_EOP_EMPTY               : in  std_logic_vector(11 downto 0)  := (others => 'X');
            O_TX_MAC_READY                   : out std_logic_vector(3 downto 0);
            ...
            O_RX_MAC_VALID                   : out std_logic_vector(3 downto 0);
