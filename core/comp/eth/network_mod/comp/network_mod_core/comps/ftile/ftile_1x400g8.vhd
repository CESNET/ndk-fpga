...
architecture FULL of FTILE_1X400G8 is
    ...
    component ftile_eth_1x400g is
        port (
            ...
            O_TX_SERIAL                     : out std_logic_vector(7 downto 0);
            I_RX_SERIAL                     : in  std_logic_vector(7 downto 0)    := (others => 'X');
            O_TX_SERIAL_N                   : out std_logic_vector(7 downto 0);
            I_RX_SERIAL_N                   : in  std_logic_vector(7 downto 0)    := (others => 'X');
            ...
            I_TX_MAC_DATA                   : in  std_logic_vector(1023 downto 0) := (others => 'X');
            I_TX_MAC_VALID                  : in  std_logic                       := 'X';
            I_TX_MAC_INFRAME                : in  std_logic_vector(15 downto 0)   := (others => 'X');
            I_TX_MAC_EOP_EMPTY              : in  std_logic_vector(47 downto 0)   := (others => 'X');
            O_TX_MAC_READY                  : out std_logic;
            I_TX_MAC_ERROR                  : in  std_logic_vector(15 downto 0)   := (others => 'X');
            I_TX_MAC_SKIP_CRC               : in  std_logic_vector(15 downto 0)   := (others => 'X');
            O_RX_MAC_DATA                   : out std_logic_vector(1023 downto 0);
            O_RX_MAC_VALID                  : out std_logic;
            O_RX_MAC_INFRAME                : out std_logic_vector(15 downto 0);
            O_RX_MAC_EOP_EMPTY              : out std_logic_vector(47 downto 0);
            O_RX_MAC_FCS_ERROR              : out std_logic_vector(15 downto 0);
            O_RX_MAC_ERROR                  : out std_logic_vector(31 downto 0);
            O_RX_MAC_STATUS                 : out std_logic_vector(47 downto 0);
            ...
            I_RECONFIG_XCVR4_ADDR           : in  std_logic_vector(17 downto 0)   := (others => 'X');
            I_RECONFIG_XCVR4_BYTEENABLE     : in  std_logic_vector(3 downto 0)    := (others => 'X');
            O_RECONFIG_XCVR4_READDATA_VALID : out std_logic;
            I_RECONFIG_XCVR4_READ           : in  std_logic                       := 'X';
            I_RECONFIG_XCVR4_WRITE          : in  std_logic                       := 'X';
            O_RECONFIG_XCVR4_READDATA       : out std_logic_vector(31 downto 0);
            I_RECONFIG_XCVR4_WRITEDATA      : in  std_logic_vector(31 downto 0)   := (others => 'X');
            O_RECONFIG_XCVR4_WAITREQUEST    : out std_logic;
            I_RECONFIG_XCVR5_ADDR           : in  std_logic_vector(17 downto 0)   := (others => 'X');
            I_RECONFIG_XCVR5_BYTEENABLE     : in  std_logic_vector(3 downto 0)    := (others => 'X');
            O_RECONFIG_XCVR5_READDATA_VALID : out std_logic;
            I_RECONFIG_XCVR5_READ           : in  std_logic                       := 'X';
            I_RECONFIG_XCVR5_WRITE          : in  std_logic                       := 'X';
            O_RECONFIG_XCVR5_READDATA       : out std_logic_vector(31 downto 0);
            I_RECONFIG_XCVR5_WRITEDATA      : in  std_logic_vector(31 downto 0)   := (others => 'X');
            O_RECONFIG_XCVR5_WAITREQUEST    : out std_logic;
            I_RECONFIG_XCVR6_ADDR           : in  std_logic_vector(17 downto 0)   := (others => 'X');
            I_RECONFIG_XCVR6_BYTEENABLE     : in  std_logic_vector(3 downto 0)    := (others => 'X');
            O_RECONFIG_XCVR6_READDATA_VALID : out std_logic;
            I_RECONFIG_XCVR6_READ           : in  std_logic                       := 'X';
            I_RECONFIG_XCVR6_WRITE          : in  std_logic                       := 'X';
            O_RECONFIG_XCVR6_READDATA       : out std_logic_vector(31 downto 0);
            I_RECONFIG_XCVR6_WRITEDATA      : in  std_logic_vector(31 downto 0)   := (others => 'X');
            O_RECONFIG_XCVR6_WAITREQUEST    : out std_logic;
            I_RECONFIG_XCVR7_ADDR           : in  std_logic_vector(17 downto 0)   := (others => 'X');
            I_RECONFIG_XCVR7_BYTEENABLE     : in  std_logic_vector(3 downto 0)    := (others => 'X');
            O_RECONFIG_XCVR7_READDATA_VALID : out std_logic;
            I_RECONFIG_XCVR7_READ           : in  std_logic                       := 'X';
            I_RECONFIG_XCVR7_WRITE          : in  std_logic                       := 'X';
            O_RECONFIG_XCVR7_READDATA       : out std_logic_vector(31 downto 0);
            I_RECONFIG_XCVR7_WRITEDATA      : in  std_logic_vector(31 downto 0)   := (others => 'X');
            O_RECONFIG_XCVR7_WAITREQUEST    : out std_logic;
    ...
    signal rst_seq_state     : std_logic_vector(3 downto 0);
...
begin
    ...
    port map (
        ...
        PMA_RETUNE               => open,
        PMA_CONTROL              => open,
        PMA_STATUS               => X"0000000" & rst_seq_state,
        PMA_PTRN_EN              => open,
        PMA_TX_DIS               => open,
    ...
    port map (
        ...
        i_rst_n                         => rst_seq_rst_n,
        i_tx_rst_n                      => rst_seq_tx_rst_n,
        i_rx_rst_n                      => rst_seq_rx_rst_n,
        o_rst_ack_n                     => ftile_rst_ack_n,
        o_tx_rst_ack_n                  => ftile_tx_rst_ack_n,
