...
class root #(
    ...
    logic STRADDLING
) extends uvm_pcie_avst::root#(REGIONS, REGION_SIZE, RDY_LATENCY, STRADDLING);
    `uvm_component_param_utils(uvm_pcie_intel_r_tile::root #(REGIONS, REGION_SIZE, RDY_LATENCY, STRADDLING));
    ...
    function void build_phase(uvm_phase phase);
        ...
        uvm_pcie_avst::env_tx#(REGIONS, REGIONS_SIZE, AVST_META_UP, STRADDLING)::type_id::set_inst_override(
            env_tx#(REGIONS, REGIONS_SIZE, AVST_META_UP, STRADDLING)::get_type(),
            "m_avst_up",
            this
        );
    ...
    function void connect_phase(uvm_phase phase);
        ...
        m_avst_up.analysis_port.connect(m_valuer.analysis_export);
