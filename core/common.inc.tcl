...
lappend HIERARCHY(PACKAGES) [nb_generate_file_register_userpkg "ndk_fpga_top_pkg" "$env(NETCOPE_TEMP)ndk_fpga_top_pkg.vhd" $UCP_PREREQ]
lappend HIERARCHY(PACKAGES) [nb_generate_file_register_userpkg "ndk_fpga_common_pkg" "$env(NETCOPE_TEMP)ndk_fpga_common_pkg.vhd" $UCP_PREREQ]
