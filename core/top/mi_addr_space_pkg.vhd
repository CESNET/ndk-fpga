...
package mi_addr_space_pack is
    ...
    constant MI_ADC_ADDR_BASE : slv_array_t(MI_ADC_PORTS-1 downto 0)(32-1 downto 0)
        := ( 0 => X"0000_0000", -- Test space (debug R/W registers)
             1 => X"0000_0800", -- Clock frequency meter
             2 => X"0000_1000", -- SDM/SYSMON controller
             3 => X"0000_2000", -- BOOT controller
             4 => X"0000_3000", -- Ethernet PMD
             5 => X"0000_4000", -- Timestamp unit
